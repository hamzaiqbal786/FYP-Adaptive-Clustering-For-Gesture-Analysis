...
def parse_opts():
    ...
    parser.add_argument('--model', default='./resnet-34-kinetics-cpu.pth', type=str, help='Model file path')
    ...
    parser.add_argument('--predict',default=False,type=bool, help='Predict the videos labels')
    parser.add_argument("--train_with_features",default=4,type=int,help="1,2,3,4. 1 means 25% video 4 means 100% video features")
